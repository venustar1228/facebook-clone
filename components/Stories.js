...
function Stories() {
  ...
  return (
    <div className='w-screen sm:w-full h-44 flex items-center mt-4 bg-white rounded-[1rem]'>
        <div className='flex space-x-4 p-4 mx-auto max-w-[24rem] justify-between '>
            {storeis.map((story) => (
